...
const Home = () => {
  ...
  const [filterType, setFilterType] = useState<'all' | 'today' | 'custom' | 'range' | 'asc' | 'desc' | 'completed' | 'incomplete'>('all')
  ...
  const filteredTodos = todos
    ...
    .sort((a, b) => {
      if (filterType === 'asc') {
        return a.todo.localeCompare(b.todo, 'vi')
      } else if (filterType === 'desc') {
        return b.todo.localeCompare(a.todo, 'vi')
      }
      return 0
    })
  ...
  return (
    <>
      <Head description="Manage your todos" />
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="flex-shrink-0 transition-transform hover:scale-110 focus:outline-none rounded-lg"
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-0.5">
                    Chào mừng, <span className="font-semibold">{user.firstName} {user.lastName}</span>
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-6">
                  ...
                  <>
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        // Auto-set max end date to 30 days from start
            ...
            {!loading && (
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div className={filteredTodos && filteredTodos.length > 0 ? "lg:col-span-3" : "lg:col-span-4"}>
                        ...
                        <p className="text-gray-500 text-lg">
                          {filterType === 'all' || filterType === 'asc' || filterType === 'desc'
                            ...
                            : `Không có công việc nào ${
                                filterType === 'today' ? 'hôm nay' : 'trong khoảng thời gian này'
                              }`
                          }
                        </p>
                      </div>
